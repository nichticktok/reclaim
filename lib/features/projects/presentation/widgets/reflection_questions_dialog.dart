...
class ReflectionQuestionsDialog extends StatefulWidget {
  final ProjectTaskModel task;
  final List<MultipleChoiceQuestion> questions;

  const ReflectionQuestionsDialog({
    super.key,
    required this.task,
  ...
  @override
  State<ReflectionQuestionsDialog> createState() => _ReflectionQuestionsDialogState();
}

class _ReflectionQuestionsDialogState extends State<ReflectionQuestionsDialog> {
  ...
  Future<void> _submitProof() async {
    ...
    final proof = ProjectTaskProof(
      ...
      userId: user.uid,
      proofType: ProjectProofTypes.reflectionNote,
