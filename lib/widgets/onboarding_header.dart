...
import '../screens/onboarding/onboarding_screen.dart'; // InheritedOnboardingProgress
...
class OnboardingHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final stepIndex0 = inherited?.stepIndex ?? 0;       // zero-based
    final totalSteps = inherited?.totalSteps ?? 0;
    final stepNumber1 = stepIndex0 + 1;                 // one-based for display
        ...
        if (totalSteps > 0)
          Row(
            children: [
              ...
              Text(
                // "Step X of Y" with localization support
                '${lang.t("word_step")} ${lang.n(stepNumber1)} ${lang.t("word_of")} ${lang.n(totalSteps)}',
